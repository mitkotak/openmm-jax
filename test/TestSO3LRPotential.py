...
import models.so3lrpotential  # noqa: E402,F401
from models.so3lr import SO3LR_MODEL_PATHS  # noqa: E402
...
class TestSO3LR:
    def testCreatePureMLSystem(self):
        ...
        assert np.isclose(ENERGIES["toluene"][model], energy, rtol=1e-5)
