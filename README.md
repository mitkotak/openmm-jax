...
[OpenMM](http://openmm.org) plugin for running exported JAX functions through `JaxForce`. For using with pre-trained machine learning force fields, see [bio-mlff](https://github.com/mitkotak/bio-mlff.git).
